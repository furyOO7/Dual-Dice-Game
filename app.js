...
document.querySelector(".btn-roll").addEventListener("click", function() {
	if(gamePlaying == true){
		var dice1 = Math.floor(Math.random() * 6) + 1; // Generating Random Number
		var dice2 = Math.floor(Math.random() * 6) + 1; // Generating Random Number
		document.getElementById("dice-1").style.display = "block";
		document.getElementById("dice-2").style.display = "block";
	    // var diceDOM1 = document.querySelector("#dice-1");
	    // var diceDOM2 = document.querySelector("#dice-2");
	    // diceDOM1.style.display = "block"; // displaying dice result
	    // diceDOM2.style.display = "block"; // displaying dice result
	    document.getElementById("dice-1").src = "dice-" + dice1 + ".png";
	    document.getElementById("dice-2").src = "dice-" + dice2 + ".png";

	    if(dice1 !== 1 && dice2 !== 1){
	    	var store = dice1+dice2;
	    	regularScore += store; 
   ...
   else if (dice !== 1) 
    {
		...
		previousDiceValue = dice; */ //coding challenge 2
	}
});
